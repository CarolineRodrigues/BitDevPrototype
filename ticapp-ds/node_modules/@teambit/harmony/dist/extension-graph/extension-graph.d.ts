...
export default class DependencyGraph extends Graph<Extension, Edge> {
    ...
    enrichRuntime(runtime: RuntimeDefinition, runtimes: Runtimes, requireFn: RequireFn): Promise<([unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown, unknown] | undefined)[]>;
    add(manifest: ExtensionManifest): this;
    load(extensions: ExtensionManifest[]): this;
    getExtension(manifest: ExtensionManifest): Extension | null;
