...
class SchemaMain {
  ...
  static async provider([envs, cli, component, graphql], config, [parserSlot]) {
    const schema = new SchemaMain(parserSlot, envs, config);
    cli.register(new (_schema2().SchemaCommand)(schema, component));
    graphql.register((0, _schema3().schemaSchema)(schema)); // workspace.onComponentLoad(async (component) => {
...
(0, _defineProperty2().default)(SchemaMain, "dependencies", [_envs().EnvsAspect, _cli().CLIAspect, _component().default, _graphql().default]);
