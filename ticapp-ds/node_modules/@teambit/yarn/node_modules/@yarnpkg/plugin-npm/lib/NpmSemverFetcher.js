...
const npmConfigUtils = (0, tslib_1.__importStar)(require("./npmConfigUtils"));
const npmHttpUtils = (0, tslib_1.__importStar)(require("./npmHttpUtils"));
class NpmSemverFetcher {
    ...
    static getLocatorUrl(locator) {
        const version = semver_1.default.clean(locator.reference.slice(constants_1.PROTOCOL.length));
        if (version === null)
