...
class AspectEnv {
  ...
  getNpmIgnore(context) {
    ...
    const patterns = ['/*.ts', `${_builder().CAPSULE_ARTIFACTS_DIR}/`]; // In order to load the env preview template from core aspects we need it to be in the package of the core envs
