...
class Init {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'create or reinitialize an empty workspace');
    (0, _defineProperty2().default)(this, "group", 'start');
    (0, _defineProperty2().default)(this, "description", `initialize an empty bit scope\nhttps://${_constants().BASE_DOCS_DOMAIN}/workspace/creating-workspaces#initialize-a-workspace-on-an-existing-project`);
