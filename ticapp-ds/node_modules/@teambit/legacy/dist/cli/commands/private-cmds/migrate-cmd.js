...
function _migrate() {
  const data = require("../../../api/consumer/lib/migrate");
...
class Migrate {
  constructor() {
    ...
    (0, _defineProperty2().default)(this, "opts", [['v', 'verbose', 'showing logs for the migration process'], ['h', 'harmony', 'migrate workspace from legacy to Harmony']]);
  }
  ...
  action([scopePath], {
    ...
    if (harmony) {
      return (0, _migrate().migrateToHarmony)();
