...
function _scopeLanesList() {
  const data = _interopRequireDefault(require("../../../api/scope/lib/scope-lanes-list"));

  _scopeLanesList = function () {
    return data;
  };
...
class ListLanes {
  constructor() {
    (0, _defineProperty2().default)(this, "name", '_lanes <path> <args>');
    (0, _defineProperty2().default)(this, "private", true);
    (0, _defineProperty2().default)(this, "internal", true);
    (0, _defineProperty2().default)(this, "description", 'list lanes');
    (0, _defineProperty2().default)(this, "alias", '');
    (0, _defineProperty2().default)(this, "opts", [['', 'merge-data', 'collect merge data']]);
  }
  ...
  action([path, args], {
    ...
    return (0, _consumer().migrate)(scopePath, false).then(() => {
      return (0, _scopeLanesList().default)(scopePath, payload, mergeData);
    });
  }
