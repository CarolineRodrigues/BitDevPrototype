...
class MissingHandler {
  constructor(missing, componentDir, workspacePath, bindingPrefix, isLegacyProject) {
  ...
  groupMissingByType() {
    const byPathType = (0, _groupBy2().default)(item => {
      if (this.isLegacyProject && (item.startsWith(`${this.bindingPrefix}/`) || item.startsWith(`${_constants().DEFAULT_BINDINGS_PREFIX}/`))) {
        return 'components';
      }
