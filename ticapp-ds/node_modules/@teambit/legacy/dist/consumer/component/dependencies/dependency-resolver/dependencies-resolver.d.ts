...
declare type HarmonyEnvPeersPolicyGetter = (configuredExtensions: ExtensionDataList) => Promise<{
    [name: string]: string;
}>;
export default class DependencyResolver {
    ...
    static registerHarmonyEnvPeersPolicyGetter(func: HarmonyEnvPeersPolicyGetter): void;
    ...
    applyAutoDetectedPeersFromEnv(): Promise<void>;
    /**
