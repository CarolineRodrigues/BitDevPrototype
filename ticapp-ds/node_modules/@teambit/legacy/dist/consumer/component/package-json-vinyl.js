...
class PackageJsonVinyl extends _abstractVinyl().default {
  ...
  async write() {
    ...
    if (stat) {
      ...
      if (!this.override) {
        // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
        _logger().default.debug(`package-json-vinyl.write, ignore existing file ${this.path}`); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    ...
    _logger().default.debug(`package-json-vinyl.write, path ${this.path}`); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
