...
class PackageJson {
  ...
  static async addWorkspacesToPackageJson(rootDir, componentsDefaultDirectory, dependenciesDirectory, customImportPath) {
    ...
    this.updateWorkspacesPackages(pkg, (0, _uniq2().default)(workSpaces));
