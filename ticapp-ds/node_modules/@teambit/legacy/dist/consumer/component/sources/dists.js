...
class Dists {
  ...
  async writeDists(component, consumer, // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  writeLinks = true) {
    ...
    await dataToPersist.persistAllToFS(); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  ...
  async writeDistsLinks(component, consumer) {
    ...
    const dataToPersist = await (0, _links().getLinksInDistToWrite)(component, componentMap, consumer, consumer.bitMap);
  ...
  async getDistsToWrite(component, bitMap, consumer, // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  writeLinks = true, componentWithDependencies) {
    ...
    if (writeLinks && componentMap && componentMap.origin === _constants().COMPONENT_ORIGINS.IMPORTED) {
      const linksInDist = await (0, _links().getLinksInDistToWrite)(component, componentMap, consumer, bitMap, componentWithDependencies);
