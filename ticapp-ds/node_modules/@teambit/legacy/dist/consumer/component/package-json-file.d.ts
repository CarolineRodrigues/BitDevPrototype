...
export default class PackageJsonFile {
    ...
    static createFromComponent(componentDir: PathRelative, component: Component, excludeRegistryPrefix?: boolean | undefined, addDefaultScopeToCompId?: boolean | undefined, // for the capsule, we want the default-scope because it gets published
    addExportProperty?: boolean | undefined): PackageJsonFile;
