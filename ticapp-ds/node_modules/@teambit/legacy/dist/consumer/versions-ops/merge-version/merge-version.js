...
const applyVersionReport = (components, addName = true, showVersion = false) => {
  ...
  return components.map(component => {
    ...
    const files = Object.keys(component.filesStatus).map(file => {
      const note = component.filesStatus[file] === FileStatus.manual ? _chalk().default.white('automatic merge failed. please fix conflicts manually and then tag the results.') : '';
