...
describe('Vue docs Parser', () => {
  describe('Invalid code', () => {
    it('should returns an empty object', async () => {
      const doclets = (await (0, _().default)('this is an invalid code'))[0];
  ...
  describe('parse()', () => {
    ...
    before(async () => {
      ...
      doclet = (await (0, _().default)(componentFileContent, componentFile))[0];
    });
    ...
    describe('Method Declaration', () => {
      ...
      it('should recognize the uncommentedMethod method', () => {
        ...
        (0, _chai().expect)(methodDef).to.have.property('description').that.is.empty;
      });
    });
    describe('Properties property', () => {
      it('should parse the properties correctly', () => {
        ...
        (0, _chai().expect)(doclet.properties[0].name).to.equal('model');
