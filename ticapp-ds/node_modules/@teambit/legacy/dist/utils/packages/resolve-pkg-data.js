...
function enrichDataFromDependent(packageData, dependentDir) {
  ...
  const packageVersion = (0, _path2().default)(['dependencies', packageName], dependentPackageJson) || (0, _path2().default)(['devDependencies', packageName], dependentPackageJson) || (0, _path2().default)(['peerDependencies', packageName], dependentPackageJson);
