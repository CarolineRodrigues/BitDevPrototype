...
async function linkAction(ids, changeRelativeToModulePaths) {
...
async function link(consumer, bitIds, changeRelativeToModulePaths) {
  let codemodResults;
