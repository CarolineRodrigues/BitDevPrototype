...
const mockComponent = async componentJson => {
  const component = await _consumerComponent().default.fromString(JSON.stringify(componentJson));
  component.extensions = new (_extensionData().ExtensionDataList)();
  return component;
};
...
describe('DependencyFileLinkGenerator', () => {
  ...
  describe('generate()', () => {
    describe('using plain javascript', () => {
      ...
      let linkResult;
      before(async () => {
        const component = await mockComponent(_barFoo3().default); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

        component.componentMap = getComponentMap();
        const dependencyComponent = await mockComponent(_utilsIsString3().default);
    ...
    describe('using ES6', () => {
      describe('when dist is inside the component dir', () => {
        ...
        let linkResults;
        before(async () => {
          const component = await mockComponent(_barFoo2().default); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

          component.componentMap = getComponentMap();
          const dependencyComponent = await mockComponent(_utilsIsString2().default);
          dependencyFileLinkGenerator = new (_dependencyFileLinkGenerator().default)({
            // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
            consumer: mockConsumer(),
            // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    ...
    describe('using custom resolved modules with ES6', () => {
      describe('when dist is inside the component dir', () => {
        ...
        let linkResult;
        before(async () => {
          const component = await mockComponent(_barFoo().default); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

          component.componentMap = getComponentMap();
          const dependencyComponent = await mockComponent(_utilsIsString().default);
          dependencyFileLinkGenerator = new (_dependencyFileLinkGenerator().default)({
            // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
            consumer: mockConsumer(),
            // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    ...
    describe('using sass files', () => {
      ...
      let linkResult;
      before(async () => {
        const component = await mockComponent(_barFoo4().default); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

        component.componentMap = getComponentMap();
        const dependencyComponent = await mockComponent(_utilsIsString4().default);
        dependencyFileLinkGenerator = new (_dependencyFileLinkGenerator().default)({
          // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
          consumer: mockConsumer(),
          // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
