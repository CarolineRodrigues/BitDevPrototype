...
class Symlink {
  ...
  writeWithNativeFS() {
    ...
    this._throwForMissingDistOutsideComponent(); // TODO: change to fs.lstatSync(dest, {throwIfNoEntry: false});
    ...
    try {
      exists = _fsExtra().default.lstatSync(dest); // eslint-disable-next-line no-empty
    } catch (e) {}
