...
class DependencyFileLinkGenerator {
  ...
  constructor({
    ...
    (0, _componentSchema().throwForNonLegacy)(component.isLegacy, DependencyFileLinkGenerator.name);
  ...
  _getPackageName() {
    return (0, _componentIdToPackageName().default)(this.dependencyComponent);
  } // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
