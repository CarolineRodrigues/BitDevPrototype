...
class LinkFile extends _sources().AbstractVinyl {
  ...
  async write() {
    ...
    if (stat) {
      ...
      if (!this.override) {
        // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
        const fileContent = _fsExtra().default.readFileSync(this.path).toString(); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    ...
    const data = this.writeAutoGeneratedMessage ? _constants().AUTO_GENERATED_MSG + this.contents : this.contents; // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    ...
    try {
      ...
      if (err.code === 'EISDIR') {
        // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
        _logger().default.debug(`deleting a directory ${this.path} in order to write a link file with the same name`); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!


        await _fsExtra().default.remove(this.path); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
