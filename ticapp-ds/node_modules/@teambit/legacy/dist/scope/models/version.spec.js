  ...
  describe('validate()', () => {
    ...
    describe('Harmony schema', () => {
      ...
      it('should throw for having compiler set on Harmony', () => {
        (0, _chai().expect)(validateFunc).to.throw('the compiler field is not permitted according to schema "1.0.0"');
      });
      it('should throw for having dists set on Harmony', () => {
        delete version.compiler;
        (0, _chai().expect)(validateFunc).to.throw('the dists field is not permitted according to schema "1.0.0"');
      });
