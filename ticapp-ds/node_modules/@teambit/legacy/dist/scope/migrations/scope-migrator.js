...
async function migrate(migrations, objects, verbose = false) {
  ...
  (0, _forEach2().default)(_runAllMigrationsForObject(migrations), objects); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

  (0, _forEach2().default)(_getRealObjectWithUpdatedRefs(result, refsIndex), objects);
  result.newObjects = (0, _values2().default)(result.newObjects); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
