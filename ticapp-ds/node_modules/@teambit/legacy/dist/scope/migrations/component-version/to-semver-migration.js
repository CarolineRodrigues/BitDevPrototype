...
function changeVersionToSemVer(versionModel) {
  ...
  const dependencies = (0, _map2().default)(getUpdatedDependency, versionModel.dependencies); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!

  const flattenedDependencies = (0, _map2().default)(_getUpdatedId, versionModel.flattenedDependencies); // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
