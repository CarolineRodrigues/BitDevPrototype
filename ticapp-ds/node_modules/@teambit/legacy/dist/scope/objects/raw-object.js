...
class BitRawObject {
  ...
  constructor(buffer, ref, type, content, // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  parsedContent) {
  ...
  clone() {
    const parsedContent = this.parsedContent ? (0, _clone2().default)(this.parsedContent) : undefined; // TODO: Should also clone the buffers (content)
    // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
