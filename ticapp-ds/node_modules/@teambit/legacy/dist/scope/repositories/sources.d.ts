...
export default class SourceRepository {
     ...
     */
    removeComponentVersions(component: ModelComponent, versions: string[], allVersionsObjects: Version[], lane: Lane | null): void;
    /**
     * needed during untag.
     ...
     */
    mergeLane(lane: Lane, isImport: boolean): Promise<{
        mergeResults: MergeResult[];
