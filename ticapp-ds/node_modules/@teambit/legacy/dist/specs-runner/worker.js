...
const testOneComponent = verbose => async id => {
  // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  const res = await (0, _test().testInProcess)(id, false, verbose); // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
