...
exports.FileStatusWithoutChalk = void 0;
...
function _e2eCapsulesHelper() {
  const data = _interopRequireDefault(require("./e2e-capsules-helper"));

  _e2eCapsulesHelper = function () {
    return data;
  };
...
class Helper {
  constructor(helperOptions) {
    ...
    (0, _defineProperty2().default)(this, "capsules", void 0);
    ...
    this.capsules = new (_e2eCapsulesHelper().default)(this.command);
  }
