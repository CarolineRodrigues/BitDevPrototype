...
class CLIParser {
  ...
  handleCommandFailure() {
    _yargs().default.fail((msg, err) => {
      ...
      _yargs().default.showHelp(this.logCommandHelp.bind(this)); // eslint-disable-next-line no-console
  ...
  parseCommandWithSubCommands(command) {
    ...
    const builderFunc = () => {
      ...
      _yargs().default.options(yarnCommand.getGlobalOptions(command));
  ...
  logCommandHelp(help) {
    ...
    const descriptionColored = description.map(desc => _chalk().default.yellow(desc));
