...
export declare class WebpackMain {
    ...
    createBundler(context: BundlerContext, transformers?: WebpackConfigTransformer[], initialConfigs?: webpack.Configuration[]): WebpackBundler;
...
export declare function runTransformersWithContext(config: WebpackConfigMutator, transformers: (WebpackConfigTransformer | WebpackConfigDevServerTransformer)[] | undefined, context: WebpackConfigTransformContext | WebpackConfigDevServerTransformContext): WebpackConfigMutator;
