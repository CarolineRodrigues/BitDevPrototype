...
export declare class DocsMain {
     ...
     * envs extension.
     */
    preview: PreviewMain, pkg: PkgMain, compiler: CompilerMain, workspace: Workspace, logger: Logger, devFiles: DevFilesMain, docPropSlot: DocPropSlot, docReaderSlot: DocReaderSlot);
    /**
    ...
    getDoc(component: Component): Doc | null;
    getPatterns(): string[];
    /**
    ...
    static provider([preview, graphql, workspace, pkg, compiler, loggerAspect, devFiles]: [
        PreviewMain,
        GraphqlMain,
        Workspace,
        PkgMain,
