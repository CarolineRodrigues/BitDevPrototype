...
export declare class BuildPipe {
     ...
     */
    static from(tasksQueue: TasksQueue, envsBuildContext: EnvsBuildContext, logger: Logger, artifactFactory: ArtifactFactory, previousTaskResults?: TaskResults[]): BuildPipe;
}
