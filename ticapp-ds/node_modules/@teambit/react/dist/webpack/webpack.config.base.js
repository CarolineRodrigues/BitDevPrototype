...
const moduleFileExtensions = ['web.mjs', 'mjs', 'web.js', 'js', 'cjs', 'web.ts', 'ts', 'web.tsx', 'tsx', 'json', 'web.jsx', 'jsx', 'mdx', 'md']; // Source maps are resource heavy and can cause out of memory issue for large source files.
