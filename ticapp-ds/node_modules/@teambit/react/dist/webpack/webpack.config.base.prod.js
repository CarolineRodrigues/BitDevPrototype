...
function _default(externalizePeer, peers, dev) {
  const externals = externalizePeer ? (0, _getExternals().getExternals)(peers) : undefined;
  const exposedRules = externalizePeer ? undefined : (0, _getExposedRules().getExposedRules)(peers);
  const module = externalizePeer ? undefined : {
    rules: exposedRules
  };
