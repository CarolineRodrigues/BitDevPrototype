...
const urlParams = new URLSearchParams(querystring); // Connect to WebpackDevServer via a socket.
...
function canAcceptErrors() {
  ...
  const status = module.hot.status(); // React refresh can handle hot-reloading over errors.
...
function tryApplyUpdates(onHotUpdateSuccess) {
  ...
  function handleApplyUpdates(err, updatedModules) {
    const haveErrors = err || hadRuntimeError; // When there is no error but updatedModules is unavailable,
