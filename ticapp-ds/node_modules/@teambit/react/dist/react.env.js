...
function _transformers() {
  const data = require("./webpack/transformers");
...
class ReactEnv {
  ...
  getDevServer(context, transformers = []) {
    ...
    const peerAliasesTransformer = (0, _transformers().generateAddAliasesFromPeersTransformer)(peers);
  ...
  async createComponentsWebpackBundler(context, transformers = []) {
    ...
    const baseProdConfig = (0, _webpackConfigBase().default)(Boolean(context.externalizePeer), peers, context.development);
