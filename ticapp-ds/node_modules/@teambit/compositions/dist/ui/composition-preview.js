...
function ComponentComposition(_ref) {
  let {
    ...
    queryParams = []
      ...
      rest = (0, _objectWithoutProperties2().default)(_ref, ["composition", "queryParams"]);
  ...
  return /*#__PURE__*/_react().default.createElement(_previewUi().ComponentPreview, (0, _extends2().default)({}, rest, {
    style: {
      width: '100%',
      height: '100%'
    },
