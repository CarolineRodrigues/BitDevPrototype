...
class NodeMain {
  ...
  static async provider([loggerAspect, envs, application, react, generator]) {
    ...
    generator.registerComponentTemplate([_nodeEnv().nodeEnvTemplate, _node3().nodeTemplate]);
...
(0, _defineProperty2().default)(NodeMain, "dependencies", [_logger().LoggerAspect, _envs().EnvsAspect, _application().ApplicationAspect, _react().ReactAspect, _generator().GeneratorAspect]);
