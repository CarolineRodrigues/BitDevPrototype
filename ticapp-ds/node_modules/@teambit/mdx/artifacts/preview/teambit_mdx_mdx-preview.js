...
The modularity that's offered by both technologies (MDX and Bit) enables MDX files to be exported to a remote scope and imported to other web projects, just like any other Bit component.`),(0,_react2.mdx)("h4",null,"Example"),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-md"},`---
...
<LoginForm><LoginForm/>
\`\`\`
`)),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre"},`// An example of a documented component file-structure
...
\u251C\u2500\u2500 login-form
    ...
    \u251C\u2500\u2500 login-form.spec.tsx
    \u2514\u2500\u2500 login-form.tsx
`)),(0,_react2.mdx)("h4",null,"Features"),(0,_react2.mdx)("ul",null,(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("strong",{parentName:"li"},"Powerful component composition"),": Author clear and engaging documentation that integrates readable Markdown syntax, Bit's live playground and your own customized components."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("strong",{parentName:"li"},"Docs that look and feel like Bit"),": Component docs written with MDX (like the one you're reading right now) are themed using Bit's [Documenter design system to provide a look-and-feel that is consistent with the Workspace/Scope UI."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("strong",{parentName:"li"},"Bit component frontmatter"),": Use Bit's YAML frontmatter to add or override metadata to the component being documented."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("strong",{parentName:"li"},"A simple-to-use live playground"),": Use MDX's user-friendly syntax to add live examples of code. No need to worry about dependencies - any module used by the doc file will also be available to code running in the live playground."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("strong",{parentName:"li"},"Independent MDX components"),': Author consumable independent content components that can be shared across web projects. Use it to maintain a consistent "voice & tone" and to keep your content always up-to-date.')),(0,_react2.mdx)("h2",null,"Quick start"),(0,_react2.mdx)("p",null,"The MDX aspect is used by various Bit environments. To use it, set your workspace configuration to use an MDX supported environment."),(0,_react2.mdx)("p",null,"As a default, MDX will only be used for component documentation. To enable the compilation of MDX components, set the ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"mdx")," property to ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"true"),"."),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-json"},`{
...
`)),(0,_react2.mdx)("h2",null,"Usage"),(0,_react2.mdx)("h4",null,"Using the frontmatter API"),(0,_react2.mdx)("p",null,`Bit parses your code to generate metadata for your components. This metadata is presented in the component's documentation and is used by Bit.dev's search engine.
To override it, use Bit's frontmatter properties, at the top of your MDX file.`),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-md"},`---
displayName: Login Form
description: My customized description
labels: ['react', 'typescript', 'ui', 'form']
---
`)),(0,_react2.mdx)("ul",null,(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("inlineCode",{parentName:"li"},"displayName")," ",(0,_react2.mdx)("em",{parentName:"li"},"string")," overrides the component name."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("inlineCode",{parentName:"li"},"description")," ",(0,_react2.mdx)("em",{parentName:"li"},"string")," overrides the component description/abstract."),(0,_react2.mdx)("li",{parentName:"ul"},(0,_react2.mdx)("inlineCode",{parentName:"li"},"labels")," ",(0,_react2.mdx)("em",{parentName:"li"},"string[]")," overrides the component labels/tags.")),(0,_react2.mdx)("h4",null,"Using the live playground"),(0,_react2.mdx)("p",null,"To use Bit's live playground add ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"live=true")," to your codeblock."),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-jsx"},"```jsx live=true\n    () => {\n        return <p> Hello World! </p>\n    }\n```;\n")),(0,_react2.mdx)("p",null,"The above MDX snippet will be rendered like so:"),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-jsx",metastring:"live=true",live:"true"},`() => {
  return <p> Hello World! </p>;
};
`)),(0,_react2.mdx)("h4",null,"Using the live playground with external modules"),(0,_react2.mdx)("p",null,"The live playground can access the docs file dependencies. To use an external module, first import it to the docs file."),(0,_react2.mdx)("p",null,"For example:"),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-jsx"},`---
...
`)),(0,_react2.mdx)("h2",null,"Use-cases and best practices"),(0,_react2.mdx)("h3",null,"Documenting components"),(0,_react2.mdx)("p",null,`The MDX format is perfect for writing documentation for components as it joins together the ease-of-use and readability
...
That will help in keeping your docs always up-to-date as changes made to a sub-component will propagate to the component's docs.`),(0,_react2.mdx)("blockquote",null,(0,_react2.mdx)("p",{parentName:"blockquote"},`Linking to external pages is, in many cases, the result of technological limitations and not the preferred solution.
If most people reading your docs need to visit an external page in order for them to get the full explanation,
then it makes more sense to have that external text integrated into your docs (by importing it).`)),(0,_react2.mdx)("br",null),"Now that we have MDX and Bit, that can be done quite easily.",(0,_react2.mdx)("p",null,"To start writing your docs with MDX, add a ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"*.docs.mdx")," or ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"*.docs.md")," file to the component's directory and Bit will render it in the component's 'Overview' tab, in the Workspace UI (and later on, after it is exported, in the Scope UI). Bit's development server will hot-reload your documentation to reflect any changes made to it, in real time."),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre"},`// An example documented component file-structure
...
\u251C\u2500\u2500 login-form
    ...
    \u251C\u2500\u2500 login-form.spec.tsx
    \u2514\u2500\u2500 login-form.tsx
`)),(0,_react2.mdx)("br",null),(0,_react2.mdx)("blockquote",null,(0,_react2.mdx)("p",{parentName:"blockquote"},"Make sure the Bit environment used by your component supports MDX!")),(0,_react2.mdx)("h3",null,"Independent MDX components"),(0,_react2.mdx)("p",null,"Building with components, whether they are code or markdown, means easier maintainability and better reusability. That naturally translates into faster delivery and more consistent content across web projects."),(0,_react2.mdx)("p",null,"The MDX aspect can be used to author independent MDX components. Components can be written using MDX and compiled to plain JS, to be consumed by other web projects. Since the MDX aspect is used and handled by your environment, this feature is turned on using the environment's configurations."),(0,_react2.mdx)("p",null,"For example, to turn on this feature in ",(0,_react2.mdx)("inlineCode",{parentName:"p"},"@teambit.react/react")," environment:"),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-json"},`{
  "teambit.workspace/variants": {
    "*": {
      "teambit.react/react": {
        "mdx": true
...
`)),(0,_react2.mdx)("h3",null,"Collaborating with non-developers"),(0,_react2.mdx)("p",null,"Your docs are not only for other developers. A component's documentation can be used as a hub for collaboration between different stakeholders."),(0,_react2.mdx)("p",null,"The verbal descriptions, live examples, images and links to other related artifacts, are all communicating the component's story with little or no code."),(0,_react2.mdx)("br",null),(0,_react2.mdx)("p",null,'The below example shows easily detectable discrepancies between design and implementation, seen in a demo documentation for a "button" component.'),(0,_react2.mdx)("iframe",{style:{borderRadius:6,border:"1px solid #ededed",marginBottom:25},width:"100%",height:"450",src:"https://www.figma.com/embed?embed_host=share&url=https%3A%2F%2Fwww.figma.com%2Ffile%2FjuFzg6Qsc3UKhJ5HZKQZE2%2FBase-UI-Buttons%3Fnode-id%3D465%253A941",allowfullscreen:!0}),(0,_react2.mdx)("pre",null,(0,_react2.mdx)("code",{parentName:"pre",className:"language-jsx",metastring:"live=true",live:"true"},`// Buttons do not follow the design when 'disabled'
<>
...
`))))}MDXContent.__bit_component=__bit_component,MDXContent.isMDXComponent=!0},32532:(__unused_webpack_module,exports2,__webpack_require__2)=>{"use strict";var __bit_component={id:"teambit.mdx/mdx@0.0.673",homepage:"https://bit.dev/teambit/mdx/mdx",exported:!0},_interopRequireDefault=__webpack_require__2(88244);Object.defineProperty(exports2,"__esModule",{value:!0}),exports2.Logo=void 0;function _react(){const data=_interopRequireDefault(__webpack_require__2(63804));return _react=function(){return data},data}_react.__bit_component=__bit_component;const Logo=()=>_react().default.createElement("div",{style:{height:"100%",display:"flex",justifyContent:"center"}},_react().default.createElement("img",{style:{width:70},src:"https://static.bit.dev/brands/logo-mdx.svg"}));Logo.__bit_component=__bit_component,exports2.Logo=Logo},72945:(__unused_webpack_module,__webpack_exports__2,__webpack_require__2)=>{"use strict";__webpack_require__2.r(__webpack_exports__2),__webpack_require__2.d(__webpack_exports__2,{default:()=>__WEBPACK_DEFAULT_EXPORT__});const __WEBPACK_DEFAULT_EXPORT__={Button:"button_Button__1481h"}},62454:(__unused_webpack_module,__webpack_exports__2,__webpack_require__2)=>{"use strict";__webpack_require__2.r(__webpack_exports__2),__webpack_require__2.d(__webpack_exports__2,{default:()=>__WEBPACK_DEFAULT_EXPORT__});const __WEBPACK_DEFAULT_EXPORT__={low:"elevations_low__2Tgzq",medium:"elevations_medium__L2g-Q",high:"elevations_high__2ME70"}},74591:(__unused_webpack_module,__webpack_exports__2,__webpack_require__2)=>{"use strict";__webpack_require__2.r(__webpack_exports__2),__webpack_require__2.d(__webpack_exports__2,{default:()=>__WEBPACK_DEFAULT_EXPORT__});const __WEBPACK_DEFAULT_EXPORT__={dotsLoader:"dots-loader_dotsLoader__2pq_Q","scale-down":"dots-loader_scale-down__3RSOw"}},94229:(__unused_webpack_module,__webpack_exports__2,__webpack_require__2)=>{"use strict";__webpack_require__2.r(__webpack_exports__2),__webpack_require__2.d(__webpack_exports__2,{default:()=>__WEBPACK_DEFAULT_EXPORT__});const __WEBPACK_DEFAULT_EXPORT__={vanillaButton:"button_vanillaButton__1MHS_"}},85057:module2=>{"use strict";module2.exports=MdxJsReact},63804:module2=>{"use strict";module2.exports=React},58459:module2=>{"use strict";module2.exports=TeambitMdxUiMdxScopeContext}},__webpack_module_cache__={};function __webpack_require__(moduleId){var cachedModule=__webpack_module_cache__[moduleId];if(cachedModule!==void 0)return cachedModule.exports;var module2=__webpack_module_cache__[moduleId]={id:moduleId,loaded:!1,exports:{}};return __webpack_modules__[moduleId].call(module2.exports,module2,module2.exports,__webpack_require__),module2.loaded=!0,module2.exports}__webpack_require__.n=module2=>{var getter=module2&&module2.__esModule?()=>module2.default:()=>module2;return __webpack_require__.d(getter,{a:getter}),getter},__webpack_require__.d=(exports2,definition)=>{for(var key in definition)__webpack_require__.o(definition,key)&&!__webpack_require__.o(exports2,key)&&Object.defineProperty(exports2,key,{enumerable:!0,get:definition[key]})},__webpack_require__.g=function(){if(typeof globalThis=="object")return globalThis;try{return this||new Function("return this")()}catch{if(typeof window=="object")return window}}(),__webpack_require__.o=(obj,prop)=>Object.prototype.hasOwnProperty.call(obj,prop),__webpack_require__.r=exports2=>{typeof Symbol<"u"&&Symbol.toStringTag&&Object.defineProperty(exports2,Symbol.toStringTag,{value:"Module"}),Object.defineProperty(exports2,"__esModule",{value:!0})},__webpack_require__.nmd=module2=>(module2.paths=[],module2.children||(module2.children=[]),module2);var __webpack_exports__={};return(()=>{"use strict";__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{compositions:()=>compositions,overview:()=>overview});const compositions=[__webpack_require__(32532)],overview=[__webpack_require__(60110)]})(),__webpack_exports__})()});
