...
class ReactNativeMain {
  ...
  overrideDependencies(dependencyPolicy) {
    return this.envs.override({
      getDependencies: () => (0, _lodash().merge)(dependencyPolicy, this.reactNativeEnv.getDependencies())
    });
  }
  /**
  ...
  static async provider([react, envs, generator]) {
    ...
    const reactNativeComposedEnv = envs.merge(new (_reactNative3().ReactNativeEnv)(react), react.compose([react.useWebpack(webpackModifiers), react.overrideJestConfig(jestConfig)]));
