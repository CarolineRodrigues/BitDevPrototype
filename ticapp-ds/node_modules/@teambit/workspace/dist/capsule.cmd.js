...
class CapsuleDeleteCmd {
  constructor(isolator, workspace) {
    ...
    (0, _defineProperty2().default)(this, "description", `delete capsules. with no args, only workspace's capsules are deleted`);
    (0, _defineProperty2().default)(this, "shortDescription", `delete capsules`);
    (0, _defineProperty2().default)(this, "group", 'capsules');
    (0, _defineProperty2().default)(this, "alias", '');
