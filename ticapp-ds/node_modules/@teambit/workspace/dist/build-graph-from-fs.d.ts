...
export declare type ShouldIgnoreFunc = (bitId: BitId) => Promise<boolean>;
export declare class GraphFromFsBuilder {
    ...
    private consumer;
    constructor(workspace: Workspace, logger: Logger, ignoreIds?: BitIds, shouldLoadItsDeps?: ShouldIgnoreFunc | undefined);
    /**
