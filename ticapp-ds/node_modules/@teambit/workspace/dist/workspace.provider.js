...
async function provideWorkspace([pubsub, cli, scope, component, isolator, dependencyResolver, variants, loggerExt, graphql, ui, bundler, aspectLoader, envs, community], config, [onComponentLoadSlot, onComponentChangeSlot, onComponentAddSlot, onComponentRemoveSlot, onPreWatchSlot], harmony) {
  var _envsCommand$commands, _envsCommand$commands2, _envsCommand$commands3;
  ...
  const workspace = new (_workspace().Workspace)(pubsub, config, consumer, scope, component, isolator, dependencyResolver, variants, aspectLoader, logger, undefined, harmony, onComponentLoadSlot, onComponentChangeSlot, envs, onComponentAddSlot, onComponentRemoveSlot, onPreWatchSlot, graphql);
  ...
  const commands = [new (_install().default)(workspace, logger), new (_update().default)(workspace), new (_uninstall().default)(workspace), new (_ejectConf().default)(workspace), capsuleCmd];
  ...
  if (workspace && !workspace.consumer.isLegacy) {
    ...
    cli.unregister('link');
    commands.push(new (_link().LinkCommand)(workspace, logger, community.getDocsDomain()));
  }
