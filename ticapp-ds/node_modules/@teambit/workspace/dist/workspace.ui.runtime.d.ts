...
export declare class WorkspaceUI {
     ...
     * sidebar link slot
     */
    sidebarItemSlot: SidebarItemSlot, drawerWidgetSlot: DrawerWidgetSlot, drawerComponentsFiltersSlot: ComponentFiltersSlot, commandBarUI: CommandBarUI, reactRouterUI: ReactRouterUI);
    ...
    }>>) | ((registerFn: () => string) => SlotRegistry<DrawerWidgetSlot>))[];
