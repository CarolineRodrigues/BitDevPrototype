...
class ResumeExportCmd {
  constructor(scope) {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'EXPERIMENTAL. resume failed export');
    (0, _defineProperty2().default)(this, "description", `resume failed export to persist the pending objects on the given remotes.
