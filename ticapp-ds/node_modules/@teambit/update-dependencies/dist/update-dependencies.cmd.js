...
class UpdateDependenciesCmd {
  constructor(updateDependenciesMain, scope, logger) {
    ...
    (0, _defineProperty2().default)(this, "shortDescription", 'update dependencies for components and tag/snap the results');
    (0, _defineProperty2().default)(this, "description", `update versions dependencies for components and tag/snap the results.
