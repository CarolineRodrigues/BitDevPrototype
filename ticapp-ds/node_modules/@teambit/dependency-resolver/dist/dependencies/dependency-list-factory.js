...
class DependencyListFactory {
  ...
  async getMissingDependenciesByComponentFromModel(legacyComponent) {
    ...
    const depListFromModel = await this.getDependenciesFromLegacyModelComponent(componentFromModel); // Only deps from model which are also required in the current component on fs (currently missing)
