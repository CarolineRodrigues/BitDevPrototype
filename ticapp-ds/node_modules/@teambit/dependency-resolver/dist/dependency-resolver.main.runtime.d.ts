import { Component, ComponentMap, ComponentMain } from '@teambit/component';
...
export declare class DependencyResolverMain {
    ...
    private getComponentEnvPolicyFromEnv;
    /**
     ...
     */
    getOutdatedPkgsFromPolicies({ rootDir, variantPoliciesByPatterns, componentPoliciesById, }: {
        rootDir: string;
